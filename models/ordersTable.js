...
export const createOrdersTable = async () => {
    try {
        const query = ` CREATE TABLE IF NOT EXISTS orders(
            ...
            tax_price DECIMAL(6, 2) NOT NULL CHECK(tax_price >= 0),
            shipping_price DECIMAL(6, 2) NOT NULL CHECK(shipping_price >= 0),
        ...
        console.error("Failed while creating orders table: ", error)
        process.exit(1)
    }
}